...
You can download the latest jar at [https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.16.11/jnats-2.16.11.jar](https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.16.11/jnats-2.16.11.jar).

The examples are available at [https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.16.11/jnats-2.16.11-examples.jar](https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.16.11/jnats-2.16.11-examples.jar).
